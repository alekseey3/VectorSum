...
Распараллелена операция суммирования элементов вектора. Это эффективно на GPU, потому что:
 1) Каждый элемент можно обрабатывать независимо;
 2) Операция повторяется одинаково для большого числа элементов;
 3) GPU хорошо подходит для массовой параллельной обработки данных.
