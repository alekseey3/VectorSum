...
## Описание реализации
На CPU реализовано последовательное суммирование элементов массива. Для ускорения используется `Numba` (`@njit`), чтобы снизить накладные расходы Python.На GPU используется **PyTorch CUDA**. Вектор копируется на устройство `cuda`, после чего операция `torch.sum()` выполняется на GPU.
С точки зрения параллельных вычислений на GPU распараллелено суммирование элементов вектора. Разные элементы обрабатываются одновременно большим количеством потоков GPU, после чего частичные суммы объединяются в итоговую сумму (редукция).
...
0	1000	0.001	0.338	0.00	490.256553	490.256553	490.256561	True	True
1	10000	0.010	0.207	0.05	4957.030763	4957.030763	4957.030762	True	True
2	50000	0.022	0.096	0.23	25017.060711	25017.060711	25017.060547	True	True
3	100000	0.044	0.118	0.37	50061.630279	50061.630279	50061.628906	True	True
4	250000	0.110	0.081	1.36	125028.753408	125028.753408	125028.757812	True	True
5	500000	0.219	0.093	2.37	250312.363437	250312.363437	250312.359375	True	True
6	1000000	0.438	0.084	5.22	499459.123219	499459.123219	499459.125000	True	True
